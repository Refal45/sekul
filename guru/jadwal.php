...
// Ambil data jadwal
// Jika admin, tampilkan semua jadwal. Jika guru, tampilkan hanya jadwalnya
...
// Filter berdasarkan role atau guru
if ($role !== 'admin') {
    // Jika guru, filter jadwal yang mengajar
    $sql .= " WHERE p.id_petugas = :id_petugas";
}
            ...
            <div class="mobile-header-container lg:hidden" id="mobileHeaderContainer">
                ...
                <header class="main-header mobile-header flex justify-between items-center">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm font-bold truncate">Jadwal Mengajar</div>
                        <div class="text-slate-500 text-xs truncate">Manajemen jadwal mengajar guru</div>
                    </div>
                ...
                <header class="main-header desktop-header flex justify-between items-center">
                    <div>
                        <h1 class="text-xl font-bold flex items-center gap-2">
                            <i class="fa-solid fa-calendar-alt text-blue-600"></i> Jadwal Mengajar
                        </h1>
                        <p class="text-slate-500 mt-1">Manajemen jadwal mengajar guru</p>
                    </div>
                ...
                <main class="page-content overflow-y-auto">
                    ...
                    <div class="card p-4 mb-6">
                        ...
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                            <a href="tambah-jadwal.php" class="btn btn-success">
                                <i class="fa-solid fa-plus mr-2"></i> Tambah Jadwal
                            </a>

                            <div class="w-full lg:w-64">
                                <input type="text" id="searchInput" placeholder="Cari Tingkat / Mapel / Kelas..."
                                    class="search-input">
                            </div>
                        </div>
                                                ...
                                                <tr class="border-t hover:bg-slate-50 <?= $isBerlangsung ? 'jadwal-berlangsung' : ($isSelesai ? 'jadwal-selesai' : '') ?>"
                                                    ...
                                                    <td class="py-3 px-4">
                                                        <div class="flex flex-wrap gap-2">
                                                            <a href="edit-jadwal.php?id=<?= $j['id_jadwal']; ?>"
                                                                class="btn btn-warning px-3 py-1 text-sm">
                                                                <i class="fa-solid fa-pen mr-1"></i> Edit
                                                            </a>
                                                            <a href="hapus-jadwal.php?id=<?= $j['id_jadwal']; ?>"
                                                                onclick="return confirmHapus(this);"
                        ...
                        <?php if (empty($jadwal)): ?>
                            <div class="empty-state">
                                ...
                                <p>Belum ada data jadwal mengajar</p>
                                <p class="text-sm mt-2">Klik tombol "Tambah Jadwal" untuk menambahkan data</p>
                            </div>
                        <?php endif; ?>
                    </div>

                    <footer class="mt-6 text-center text-sm text-slate-500 select-none pb-4">
                        &copy; <?= date('Y'); ?> Sekolah - Jadwal Mengajar Management
                    </footer>
                </main>
            </div>
        </div>
    ...
    <script>
        ...
        searchInput.addEventListener("keyup", () => {
            ...
            rows.forEach(row => {
                ...
                if (tingkat.includes(filter) || mapel.includes(filter) || kode.includes(filter)) {
                    row.style.display = "";
                } else {
