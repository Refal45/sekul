...
<body>
    <div class="flex h-screen">
        <!-- Sidebar (Tetap sama dengan versi Guru) -->
            ...
            <div class="content-wrapper content-spacing">
                <main class="page-content overflow-y-auto">
                    ...
                    <div class="card p-4 mb-6">
                        ...
                        <!-- Header dan Search (Sama dengan Admin) -->
                        ...
                        <!-- Tabel Kehadiran (Sama dengan Admin) -->
    ...
    <script>
        ...
        // Search functionality (Sama dengan Admin)
        ...
        // Add keyboard shortcuts (Sama dengan Admin)
        document.addEventListener('keydown', (e) => {
            // Ctrl+P for print
