...
// Ambil data guru dari tabel petugas
$stmt = $pdo->prepare("SELECT id_petugas, username, nama_petugas, nip, no_hp FROM petugas WHERE role='guru' ORDER BY id_petugas DESC");
$stmt->execute();
...
<head>
    ...
    <title>Data Guru - Sistem Sekolah</title>
            ...
            <div class="mobile-header-container lg:hidden" id="mobileHeaderContainer">
                ...
                <header class="main-header mobile-header flex justify-between items-center">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm font-bold truncate">Data Guru</div>
                        <div class="text-slate-500 text-xs truncate">Manajemen akun guru sekolah</div>
                    </div>
                ...
                <header class="main-header desktop-header flex justify-between items-center">
                    <div>
                        <h1 class="text-xl font-bold flex items-center gap-2">
                            <i class="fa-solid fa-user-tie text-blue-600"></i> Data Guru
                        </h1>
                        <p class="text-slate-500 mt-1">Manajemen akun guru sekolah</p>
                    </div>
                ...
                <main class="page-content overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-6 auto-rows-fr">
                        <div class="card stat-card">
                            ...
                            <p class="stat-value text-green-600"><?= $totalGurus; ?></p>
                        </div>
                        <div class="card stat-card">
                            <div class="stat-icon text-blue-600">
                                <i class="fa-solid fa-users"></i>
                            </div>
                            <h3 class="stat-label">Guru Aktif</h3>
                            <p class="stat-value text-blue-700"><?= $totalGurus; ?></p>
                        </div>
                        <div class="card stat-card">
                            ...
                            <p class="stat-value text-purple-600">Aktif</p>
                        </div>
                        <div class="card stat-card">
                    ...
                    <div class="card p-4 mb-6">
                        <?php if (isset($_SESSION['flash']) && $_SESSION['flash'] === "success"): ?>
                            <div class="success-message mb-4 flex items-center justify-between">
                                <span><i class="fa-solid fa-circle-check mr-2"></i> Guru baru berhasil ditambahkan!</span>
                        ...
                        <?php if (isset($_SESSION['flash']) && $_SESSION['flash'] === "updated"): ?>
                            <div class="info-message mb-4 flex items-center justify-between">
                                <span><i class="fa-solid fa-pen-to-square mr-2"></i> Data guru berhasil diperbarui!</span>
                        ...
                        <?php if (isset($_SESSION['flash']) && $_SESSION['flash'] === "deleted"): ?>
                            <div class="warning-message mb-4 flex items-center justify-between">
                                <span><i class="fa-solid fa-trash mr-2"></i> Guru berhasil dihapus!</span>
                        ...
                        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
                            <a href="tambah-guru.php" class="btn btn-success">
                                <i class="fa-solid fa-plus mr-2"></i> Tambah Guru
                            </a>

                            <div class="w-full lg:w-64">
                                <input type="text" id="searchInput" placeholder="Cari Username / Nama Lengkap..."
                                    class="search-input">
                            </div>
                        </div>
                                    ...
                                    <?php if (!empty($gurus)): ?>
                                        ...
                                        foreach ($gurus as $g): ?>
                                            <tr class="border-t hover:bg-slate-50">
                                                ...
                                                <td class="py-3 px-4 username"><?= htmlspecialchars($g['username']); ?></td>
                                                <td class="py-3 px-4 nama"><?= htmlspecialchars($g['nama_petugas']); ?></td>
                                                <td class="py-3 px-4"><?= htmlspecialchars($g['nip'] ?: '-'); ?></td>
                                                <td class="py-3 px-4"><?= htmlspecialchars($g['no_hp'] ?: '-'); ?></td>
                                                <td class="py-3 px-4">
                                                    <div class="flex flex-wrap gap-2">
                                                        <a href="edit-guru.php?id=<?= $g['id_petugas']; ?>"
                                                            class="btn btn-warning px-3 py-1 text-sm">
                                                            <i class="fa-solid fa-pen mr-1"></i> Edit
                                                        </a>
                                                        <a href="hapus-guru.php?id=<?= $g['id_petugas']; ?>"
                                                            onclick="return confirm('Hapus guru <?= htmlspecialchars($g['nama_petugas']) ?>?');"
                                        ...
                                        <tr>
                                            <td colspan="6" class="py-8 px-4 text-center">
                                                <div class="empty-state">
                                                    ...
                                                    <p class="text-sm mt-2">Klik tombol "Tambah Guru" untuk menambahkan data</p>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endif; ?>
    ...
    <script>
        ...
        function displayTable() {
            ...
            let filteredRows = Array.from(rows).filter(row => {
                ...
                return username.includes(filter) || nama.includes(filter);
            });
        ...
        document.addEventListener('keydown', (e) => {
            ...
            // Ctrl+Shift+G untuk tambah guru
            if (e.ctrlKey && e.shiftKey && e.key === 'G') {
                e.preventDefault();
                window.location.href = 'tambah-guru.php';
            }
        });
