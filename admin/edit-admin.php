...
try {
    $stmt = $pdo->prepare("SELECT id_petugas, username, nama_petugas, nip, no_hp FROM petugas WHERE id_petugas = ? AND role='admin'");
...
<head>
    ...
    <title>Edit Admin - Sistem Sekolah</title>
            ...
            <div class="mobile-header-container lg:hidden" id="mobileHeaderContainer">
                ...
                <header class="main-header mobile-header flex justify-between items-center">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm font-bold truncate">Edit Admin</div>
                        <div class="text-slate-500 text-xs truncate">Edit data administrator</div>
                    </div>
                </header>
                ...
                <header class="main-header desktop-header flex justify-between items-center">
                    <div>
                        <h1 class="text-xl font-bold flex items-center gap-2">
                            <i class="fa-solid fa-user-edit text-yellow-600"></i> Edit Data Admin
                        </h1>
                        <p class="text-slate-500 mt-1">Perbarui informasi akun administrator</p>
                    </div>
            ...
            <div class="content-wrapper content-spacing">
                <main class="page-content overflow-y-auto">
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600 mb-6">
                        ...
                        <span class="text-blue-600 font-medium">Edit Admin</span>
                    </div>
                    ...
                    <div class="info-box">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-blue-900">Sedang mengedit data admin</h3>
                                <p class="text-blue-700 text-sm mt-1">
                                    Username: <strong><?= htmlspecialchars($admin['username']); ?></strong> |
                                    Nama: <strong><?= htmlspecialchars($admin['nama_petugas']); ?></strong>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_petugas" name="nama_petugas"
                                            value="<?= htmlspecialchars($_POST['nama_petugas'] ?? $admin['nama_petugas']); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nip" name="nip"
                                           value="<?= htmlspecialchars($_POST['nip'] ?? $admin['nip'] ?? ''); ?>"
                                            class="form-input"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="no_hp" name="no_hp"
                                            value="<?= htmlspecialchars($_POST['no_hp'] ?? ($admin['no_hp'] ?? '')); ?>"
                                            class="form-input"
