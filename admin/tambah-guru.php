    ...
    if (empty($username_input) || empty($password) || empty($nama_petugas)) {
        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                // Insert guru baru
                $stmt = $pdo->prepare("INSERT INTO petugas (username, password, nama_petugas, nip, no_hp, role) VALUES (?, ?, ?, ?, ?, 'guru')");
...
<head>
    ...
    <title>Tambah Guru - Sistem Sekolah</title>
            ...
            <div class="mobile-header-container lg:hidden" id="mobileHeaderContainer">
                ...
                <header class="main-header mobile-header flex justify-between items-center">
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-sm font-bold truncate">Tambah Guru</div>
                        <div class="text-slate-500 text-xs truncate">Tambah akun guru baru</div>
                    </div>
                </header>
                ...
                <header class="main-header desktop-header flex justify-between items-center">
                    <div>
                        <h1 class="text-xl font-bold flex items-center gap-2">
                            <i class="fa-solid fa-user-plus text-green-600"></i> Tambah Guru Baru
                        </h1>
                        <p class="text-slate-500 mt-1">Tambah akun guru baru untuk sistem sekolah</p>
                    </div>
            ...
            <div class="content-wrapper content-spacing">
                <main class="page-content overflow-y-auto">
                    ...
                    <div class="flex items-center gap-2 text-sm text-slate-600 mb-6">
                        ...
                        <span class="text-blue-600 font-medium">Tambah Guru</span>
                    </div>
                    ...
                    <div class="card p-6 mt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-700">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <strong>Hak Akses Guru</strong>
                                    <p class="text-slate-600 mt-1">Guru memiliki akses untuk mengelola mata pelajaran, nilai, dan kehadiran siswa</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3">
