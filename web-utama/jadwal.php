...
<head>
    ...
    <style>
        ...
        .jadwal-table th.senin {
            background: linear-gradient(135deg, #7fb7d9, #5a9fd4);
            color: white;
        }

        .jadwal-table th.selasa {
            background: linear-gradient(135deg, #f7c26b, #f5b042);
            color: white;
        }

        .jadwal-table th.rabu {
            background: linear-gradient(135deg, #8fb66b, #74a84a);
            color: white;
        }

        .jadwal-table th.kamis {
            background: linear-gradient(135deg, #ffb199, #ff8a7a);
            color: white;
        }

        .jadwal-table th.jumat {
...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active text-primary fw-semibold" href="jadwal.php"><i class="bi bi-calendar-week-fill me-1"></i> Jadwal</a></li>
    ...
    <section class="hero">
        <div class="container hero-content">
            <h1 class="mb-3">📅 Jadwal Pelajaran XII PPLG</h1>
            <p class="lead mb-4">Temukan jadwal pelajaran lengkap untuk kelas XII PPLG yang telah diatur dengan efisien dan terstruktur.</p>
        </div>
    </section>
                ...
                <div class="col-12">
                    <div class="jadwal-card">
                        <div class="jadwal-header">
                            <h2>JADWAL PELAJARAN XII PPLG</h2>
                        </div>
                        <div class="table-responsive">
                            <table class="jadwal-table">
                                <thead>
                                    <tr>
                                        <th class="hour">Jam</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="mapel-highlight">UPACARA</td>
                                        <td>PBO</td>
                                        <td><span class="mapel-small">PRODUKTIF<br>PA AQIL</span></td>
                                        <td>MTK</td>
                                        <td class="mapel-highlight">TADARUS</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td class="mapel-highlight">UPACARA</td>
    ...
    <script>
        ...
        document.querySelectorAll('.jadwal-table tr').forEach(row => {
